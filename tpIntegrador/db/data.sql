...
(default,2, '/images/products/folklore.jpg', 'Folklore', 'Folklore es el octavo álbum de estudio de Taylor Swift, lanzado a través de Republic Records en 2020. Incluye una versión en vinilo rojo de dos discos de la edición meet me behind the mall y 16 canciones.'),
...
(default,1, '/images/products/austin.jpg', 'Austin', 'Austin es el quinto album del cantante Post Malone. Este fue lanzado en 2023 y fue todo un éxito. Incluye dos vinilos verde oscuro translúcido tipo gatefold de 2xLP y 17 canciones inolvidables.'),
(default,2, '/images/products/starboy.jpg', 'Starboy', 'Starboy es el tercer álbum del cantante The Weeknd. Fue lanzado en 2020. Incluye 18 canciones y 2 vinilos translúcidos azules limitados.'),
(default,3, '/images/products/nevermind.jpg', 'Nevermind', 'Nevermind es el segundo albúm de estudio lanzado en 1991 de la banda Nirvana. Un exito total este disco incluye 2 vinilos LP negros y 12 increibles canciones.'),
(default,4, '/images/products/definitely.jpg', 'Definitely Maybe', 'Definetely Maybe es el álbum debut del grupo britanico Oasis. Este fue lanzado en 1994 pero esta versión de vinilo ofrece una versión remasterizada de 2019. Incluye dos vinilos LP de edición limitada plateados y 12 canciones.'),
(default,5, '/images/products/hollywood.jpg', 'Hollywoods Bleeding', 'Hollywoods Bleeding es el tercer álbum del artista Post Malone. Fue lanzado en 2019. El disco incluye 2 vinilos rosados en relieve y 17 canciones de rock/pop.');
