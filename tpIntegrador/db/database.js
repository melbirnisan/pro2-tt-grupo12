const datos = {
    ...
    productos: [
        {
            imagen: '/images/products/tortured.jpg',
            ...
            comentarios: [
                ...
                },
                {
                ...
                },
                 {
                    ...
                    imagenPerfil: "/images/users/profile4.jpg"
                }
            ]
        },
        {
            imagen: '/images/products/folklore.jpg',
            nombre: "Folklore",
        ...
        {
            imagen: '/images/products/sos.jpg',
            nombre: "SOS",
            descripcion: " SOS es el segundo álbum de estudio de la cantante SZA, ganadora de un premio GRAMMY. Fue lanzado en 2023. Incluye 2 vinilos LP y 23 hermosas canciones. ",
            comentarios: [
                {
                    persona: "valengarcia",
                    texto: "Este vinilo no solo es hermoso esteticamente sino que cada pista es mejor que la anterior. No se lo pierdan!",
        ...
        {
            imagen: '/images/products/circles.jpg',
            nombre: "Circles",
            descripcion: "Circles es el sexto y último álbum de estudio del artista Mac Miller. Fue lanzado en 2020. Incluye 2 vinilos LP de edición limitada transparentes y las últimas 14 canciones del artista.",
            comentarios: [
                {
                    persona: "valengarcia",
                    texto: "Este vinilo no solo es hermoso esteticamente sino que cada pista es mejor que la anterior. No se lo pierdan!",
        ...
        {
            imagen: '/images/products/curtain.jpg',
            nombre: "Curtain Call",
        ...
        {
            imagen: '/images/products/austin.jpg',
            nombre: "Austin",
        ...
        {
            imagen: '/images/products/starboy.jpg',
            nombre: "Starboy",
         ...
         {
            imagen: '/images/products/nevermind.jpg',
            nombre: "Nevermind",
            descripcion: " Nevermind es el segundo albúm de estudio lanzado en 1991 de la banda Nirvana. Un exito total este disco incluye 2 vinilos LP negros y 12 increibles canciones. ",
            comentarios: [
                {
                    persona: "valengarcia",
                    texto: "Este vinilo no solo es hermoso esteticamente sino que cada pista es mejor que la anterior. No se lo pierdan!",
        ...
        {
            imagen: '/images/products/definitely.jpg',
            ...
            imagen: '/images/products/hollywood.jpg',
            ...
            comentarios: [
                ...
                },
                {
                ...
                },
                 {
                    persona: "isalopez",
                    texto: "Este albúm me transporto a otro mundo. tengo la portada del vinilo colgada en mi cuarto y la musica puesta las 24hs del dia.",
                    imagenPerfil: "/images/usersprofile4.jpg"
                }
            ]
        }
